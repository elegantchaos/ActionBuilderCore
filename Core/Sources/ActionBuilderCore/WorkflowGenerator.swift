...
public class WorkflowGenerator {
    ...
    func generateYAML(for repo: RepoDetails, platforms: [Platform], compilers: [Compiler], application: BundleInfo) -> String {
     ...
     func generateHeader(for repo: RepoDetails, platforms: [Platform], compilers: [Compiler], application: BundleInfo) -> (String, String) {
         var header = ""
    ...
    public func generateWorkflow(for repo: RepoDetails, application: BundleInfo) -> Output? {
